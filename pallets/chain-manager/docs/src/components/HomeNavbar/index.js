    ...
    <nav className={`${styles.navbar} ${scrolled ? styles.scrolled : ''} ${isDocs ? styles.navbarDocs : ''}`}>
      <div className={`${styles.inner} ${isDocs ? styles.innerDocs : ''}`}>
        ...
        <Link to="/" className={`${styles.logo} ${isDocs ? styles.logoCentered : ''}`}>
          <svg className={styles.logoMark} viewBox="0 0 220 220" aria-hidden="true">
            <circle cx="110" cy="110" r="104" fill="none" stroke="currentColor" strokeWidth="3"/>
            <circle cx="110" cy="110" r="32" fill="none" stroke="currentColor" strokeWidth="4"/>
            <path d="M96,112 L106,122 L126,96" fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" className={styles.logoMarkAccent}/>
          </svg>
          <span className={styles.logoText}>
            Pallet &ndash; <span className={styles.logoAccent}>Chain Manager</span>
          </span>
        </Link>
        ...
        <ul className={styles.navLinks}>
          ...
          <li>
            <a href="https://crates.io/crates/pallet-chain-manager" className={styles.navLink} target="_blank" rel="noopener noreferrer">
              <svg className={styles.navIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li>
            {/* TODO: confirm once pallet-chain-manager is published on docs.rs -
                dropped the sibling's #line-range anchor since it's unverifiable for this crate */}
            <a href="https://docs.rs/pallet-chain-manager/latest/src/pallet_chain_manager/lib.rs.html" className={styles.navLink} target="_blank" rel="noopener noreferrer">
              <svg className={styles.navIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li>
            <a href="https://github.com/auguth/frame-suite/tree/master/pallets/chain-manager" className={styles.navLink} target="_blank" rel="noopener noreferrer">
          ...
          <li>
            {/* TODO: confirm this repo exists / correct its name before shipping */}
            <a href="https://github.com/auguth/chain-manager-substrate-template" className={styles.navLink} target="_blank" rel="noopener noreferrer">
              <svg className={styles.navIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className={`${styles.mobileMenu} ${menuOpen ? styles.mobileMenuOpen : ''}`}>
        ...
        <a href="https://crates.io/crates/pallet-chain-manager" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>
          <svg className={styles.mobileLinkIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
            <polyline points="3.27 6.96 12 12.01 20.73 6.96"/>
            <line x1="12" y1="22.08" x2="12" y2="12"/>
        ...
        <a href="https://docs.rs/pallet-chain-manager/latest/src/pallet_chain_manager/lib.rs.html" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>
          <svg className={styles.mobileLinkIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="16 18 22 12 16 6"/>
            <polyline points="8 6 2 12 8 18"/>
          </svg>
        ...
        <a href="https://github.com/auguth/frame-suite/tree/master/pallets/chain-manager" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>
        ...
        <a href="https://github.com/auguth/chain-manager-substrate-template" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>
          <svg className={styles.mobileLinkIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="3" width="7" height="7"/>
            <rect x="14" y="3" width="7" height="7"/>
            <rect x="14" y="14" width="7" height="7"/>
