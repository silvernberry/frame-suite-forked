...
const links = [
  ...
  { label: 'Crates', href: 'https://crates.io/crates/pallet-commitment' },
  { label: 'Source', href: 'https://docs.rs/pallet-commitment/latest/src/pallet_commitment/lib.rs.html#16-2537' },
  { label: 'Template', href: 'https://github.com/auguth/commitment-substrate-template' },
];
            ...
            <div className={styles.pxpBlock}>
              <div className={styles.brandRow}>
                <div className={styles.logoMark}>
                  <img src={logoMark} alt="Pallet-Commitment" className={styles.logoMarkImg} />
                </div>
                <span className={styles.brandName}>Pallet-Commitment</span>
              </div>
              <p className={styles.tagline}>
                A reusable, fungible commitment and bonding primitive with <br/> support for structured, indexed, and pooled value allocations
              </p>
              <a
