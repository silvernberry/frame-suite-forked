      ...
      <div className={styles.inner}>
        ...
        <div className={styles.grid}>
          {CHANNELS.map((c) => (
            ...
            >
              <div className={`${styles.icon} ${styles[c.iconStyle]}`}>
                {c.icon}
              </div>
          ...
          {/* <div className={`${styles.card} ${styles.cardHint}`}>
            <div className={styles.hintGlyph}>⬡</div>
            <div className={styles.cardContent}>
              <p className={styles.cardTitle}>Not sure where to start?</p>
              <p className={styles.cardDesc}>
                Discussions for general questions. Issues for bugs. Stack
                Exchange for deep technical dives.
              </p>
            </div>
          </div> */}
        </div>
