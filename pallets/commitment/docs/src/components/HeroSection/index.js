...
const PolkadotLogo = () => (
  <svg className={styles.polkadotLogo} width="18" height="18" viewBox="0 0 256 256" fill="#E6007A" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 flex-shrink-0" aria-hidden="true">
  ...
  return (
    <header className={styles.hero}>
      ...
      <div className={styles.heroContent}>
        ...
        <h1 className={styles.title}>pallet&#x2011;commitment</h1>

        <div className={styles.subtitleCode}>frame_suite::commitment</div>

        <p className={styles.desc}>
          Raw balance locks are blunt instruments. Commitment gives assets{' '}
          <strong>meaning</strong> - bonded to a <strong>reason</strong>,
          anchored to a <strong>digest</strong>, adjusted dynamically, and
          resolved with full accounting fidelity.
        </p>
